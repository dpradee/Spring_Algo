...
public class Anagram {
	...
	public static void main(String[] args) {
		//System.out.println(isAnagram("dubey","ebuyd"));
		iAnagram("dubey","ebuyd");
		Thread t1= new Thread();
		
	}
}

// javarevisited.blogspot.com/2013/03/Anagram-how-to-check-if-two-string-are-anagrams-example-tutorial.html#ixzz5VxrmLi8m